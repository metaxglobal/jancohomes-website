  ...
  return (
    <>
      ...
      <main className="relative min-h-screen overflow-hidden bg-white pt-[112px]">
        ...
        {/* Properties Section */}
        <section className="flex w-full flex-col items-center justify-start gap-5 px-4 md:px-8 lg:px-12 pb-12 pt-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center max-w-[1200px] mx-auto w-full">
