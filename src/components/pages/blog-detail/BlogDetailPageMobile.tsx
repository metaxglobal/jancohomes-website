/**
 * Blog Detail Page - Mobile View
 * Full page component for individual blog article on mobile devices
 */
...
export function BlogDetailPageMobile({
  article,
}: BlogDetailPageMobileProps) {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen overflow-hidden bg-white pt-[112px]">
        ...
        <section className="relative h-[88px] w-full overflow-hidden bg-secondary">
