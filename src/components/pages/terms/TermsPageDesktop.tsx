      ...
      <main className="relative min-h-screen overflow-hidden bg-white pt-[146px]">
        ...
        <section className="flex justify-center px-[120px] py-24">
          <div className="flex w-[794px] flex-col gap-10">
            ...
            {/* Scope of Service */}
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Scope of Service</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">User Responsibilities</h2>
              <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Intellectual Property Rights</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Project Information & Estimates</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            {/* Third-Party Links */}
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Third-Party Links</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Limitation of Liability</h2>
              <div className="flex flex-col gap-3">
                <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Privacy & Data Protection</h2>
              <div className="flex flex-col gap-6">
                <p className="text-sm leading-[14px] text-secondary/75">
                ...
                <Link 
                  href="/privacy" 
                  className="inline-flex h-12 items-center gap-2 rounded-xl border border-primary px-5 py-2.5"
                >
            ...
            {/* Communication */}
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Communication</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Governing Law & Jurisdiction</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-4xl font-medium leading-10 text-secondary">Changes to These Terms</h2>
              <p className="text-sm leading-[14px] text-secondary/75">
