      ...
      <div className="w-full max-w-[361px] sm:max-w-[500px] md:max-w-[600px] mx-auto flex flex-col items-start justify-start gap-8">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-3">
          ...
          <div className="self-stretch px-2.5 inline-flex items-center justify-center gap-2.5">
            <div className="w-full max-w-[361px] sm:max-w-[640px] md:max-w-[720px] text-center text-secondary/75 text-sm leading-[14px]" style={{ fontWeight: 400 }}>
        ...
        {/* Property Cards */}
        <div className="w-full max-w-[361px] sm:max-w-[640px] md:max-w-[720px] flex flex-col items-center justify-start gap-5">
