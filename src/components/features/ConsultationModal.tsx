        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="h-9 rounded-[12px] bg-white/10 px-3 py-1 text-[16px] leading-4 text-white outline outline-1 outline-white/20 outline-offset-[-1px] placeholder:text-[14px] placeholder:text-[#99A1AF]/60 focus:outline-2 focus:outline-primary"
            />
            {errors.name && (
          ...
          <div className="flex h-[86px] flex-col gap-4">
            ...
            <textarea
              ...
              rows={3}
              className="h-16 resize-none rounded-[12px] bg-white/10 px-3 pb-2 pt-[10px] text-[16px] leading-4 text-white outline outline-1 outline-white/20 outline-offset-[-1px] placeholder:text-[14px] placeholder:text-[#99A1AF]/60 focus:outline-2 focus:outline-primary"
            />
            {errors.message && (
