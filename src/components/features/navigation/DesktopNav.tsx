  ...
  return (
    <nav className="w-full" style={{ boxShadow: '0px 4px 6px -4px rgba(0, 0, 0, 0.10)' }}>
      ...
      <div className="w-full bg-[#1A1A1A] border-b border-white/20">
        <div className="w-full max-w-[1440px] mx-auto h-[49px] pb-px px-6 md:px-12 lg:px-12 xl:px-16 2xl:px-[120px]">
      ...
      <div className="w-full bg-[#1A1A1A]">
        <div className="w-full max-w-[1440px] mx-auto h-[97px] px-6 md:px-12 lg:px-12 xl:px-16 2xl:px-[120px] flex items-center justify-between">
          {/* Logo */}
          <Link href="/">
            <Image
              src="/janco-logo.svg"
